...
const HomePage = () => {
  ...
  let catProductsOne = products.filter(product => product.category === categories[7]);
  let catProductsTwo = products.filter(product => product.category === categories[8]);
  let catProductsThree = products.filter(product => product.category === categories[9]);
